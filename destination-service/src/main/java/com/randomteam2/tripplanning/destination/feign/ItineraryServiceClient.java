...
public interface ItineraryServiceClient {
    ...
    Integer getDestinationActiveItineraryCount(@PathVariable("destinationId") Long destinationId);

    @GetMapping("/api/itineraries/{itineraryId}")
    ItineraryDTO getItinerary(@PathVariable("itineraryId") Long itineraryId);
